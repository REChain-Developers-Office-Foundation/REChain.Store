            ...
            <div class="shadow-sm p-2 app-details bg-white rounded">
                <div class="m-1" id="redirect" data-app-id="{{ $app_query->id }}" data-redirection-delay="{{$settings['time_before_redirect']*1000}}">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="me-2"><img src="{{ s3_switch($app_query->image) }}" alt="{{ $app_query->title ?: $app_query->main_title }}" class="app-image"></div>
                        <div class="my-auto">
                            <h1 class="mb-1 d-inline">{{ $app_query->title ?: $app_query->main_title }}</h1>@if (isset($app_query->version))<span class="version ms-1">{{$app_query->version}}</span>@endif
