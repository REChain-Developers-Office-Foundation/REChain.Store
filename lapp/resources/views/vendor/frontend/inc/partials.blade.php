...
<div class="shadow-sm apps top-apps p-2 bg-white rounded mb-3">
    <div class="m-1">
        <a href="{{ asset($language_prefix.'popular-apps') }}" class="more float-end">@lang('general.more') »</a>
        ...
        <a href="{{ asset($language_prefix.$settings['app_base']) }}/{{ $app[1] }}">
            <div class="row mb-2">
                <div class="col-3 pe-0"><img src="{{ s3_switch('pixel.png') }}" data-src="{{ s3_switch($app[2] ?? 'no_image.png') }}" width="200" height="200" class="img-fluid lazy" alt="{{ $app[0] ?: $app[5] }}"></div>
...
<div class="shadow-sm apps top-apps p-2 bg-white rounded mb-3">
    <div class="m-1">
        ...
        <a href="{{ asset($language_prefix.'editors-choice') }}" class="more float-end">@lang('general.more') »</a>
        ...
        <a href="{{ asset($language_prefix.$settings['app_base']) }}/{{ $app->slug }}">
            <div class="row mb-2">
                <div class="col-3 pe-0"><img src="{{ s3_switch('pixel.png') }}" data-src="{{ s3_switch($app->image ?? 'no_image.png') }}" width="200" height="200" class="img-fluid lazy" alt="{{ $app->title ?: $app->main_title }}"></div>
...
<div class="shadow-sm apps top-apps p-2 pb-0 bg-white rounded mb-3">
    <div class="m-1 pb-1">
        ...
        <a href="{{ asset($language_prefix.'all-categories') }}" class="float-end">@lang('general.all_categories') »</a>
...
<div class="shadow-sm apps top-apps p-2 pb-0 bg-white rounded">
    <div class="m-1 pb-1">
        ...
        <a href="{{ asset($language_prefix.'all-platforms') }}" class="float-end">@lang('general.all_platforms') »</a>
...
<div class="@if (empty($settings['recommended_terms'])) mb-3 @else mb-md-3 mb-2 @endif">
    <div class="col-12">
        <form method="post" action="{{ asset($language_prefix.'search') }}" class="d-flex shadow-sm p-2 bg-white rounded">
            {{ csrf_field() }}
            <input class="form-control search-form me-2 ps-1" id="search-form" name="term" type="search" placeholder="@lang('general.search_apps')" aria-label="@lang('general.search_apps')">
