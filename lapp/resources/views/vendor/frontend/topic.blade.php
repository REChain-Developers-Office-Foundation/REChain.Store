                ...
                <div class="breadcrumbs mb-2 px-1">
                    ...
                    <div class="mt-3 topic-item">
                        ...
                        <a href="{{ asset($language_prefix.$settings['app_base']) }}/{{ $app_slug[$app] }}">
                            <div class="d-flex">
                                <div class="me-2">@if (isset($app_license[$app]))<span class="license shadow-sm">{{$app_license[$app]}}</span>@endif<img src="{{ s3_switch($app_image[$app] ?? 'no_image.png') }}" class="image" width="200" height="200" alt="{{ $app_title[$app] }}"></div>
                                <div class="flex-grow-1 my-auto ms-1">
