...
<div class="container my-3">
    ...
    <div class="row">
        ...
        <div class="col-md-9 ps-md-2">
            ...
            <div class="shadow-sm p-2 bg-white rounded mb-3 pb-1" id="history-page" data-cookie-name="{{ $settings['cookie_prefix'].'_history' }}" data-no-history="@lang('general.no_history')">
                <div class="m-1">
