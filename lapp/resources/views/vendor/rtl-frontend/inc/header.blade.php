...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm px-0 py-3" aria-label="Main navigation">
    <div class="container extend-navbar mx-md-auto mx-0">
        ...
        <a href="{{ asset($language_prefix) }}"><img src="{{ s3_switch('logo.png') }}?t={{$settings['update_count']}}" class="logo" width="128" height="30" alt="{{$settings['site_title']}}"></a>
        @else
        ...
        <div class="navbar-collapse offcanvas-collapse bg-white" id="navbarsExampleDefault" aria-labelledby="offcanvasLabel">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown me-md-1">
                    ...
                    <ul class="dropdown-menu shadow text-end" aria-labelledby="dropdown_platforms">
                ...
                <li class="nav-item dropdown me-md-1">
                    ...
                    <ul class="dropdown-menu shadow text-end" aria-labelledby="dropdown_news">
                        @foreach ($categories as $category)
                ...
                <li class="nav-item">
                    <a class="nav-link me-md-1" href="{{ asset($language_prefix.'favorites') }}">@lang('general.favorites')</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link me-md-1" href="{{ asset($language_prefix.'browse-history') }}">@lang('general.browse_history')</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link me-md-1" href="{{ asset($language_prefix.$settings['contact_slug']) }}">@lang('general.contact')</a>
                </li>
            ...
            <form class="d-flex">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle ms-0 ps-0 pt-0 pb-md-0" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false"><span class="fi fi-{{$language_icon_code}}"></span> {{$language_name}}</a>
