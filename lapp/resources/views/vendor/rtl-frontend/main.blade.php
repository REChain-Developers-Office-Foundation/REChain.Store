...
<div class="container my-3">
    ...
    <div class="row">
        ...
        <div class="col-md-9 ps-md-2">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="{{ asset($language_prefix.$settings['app_base']) }}/{{ $slider->slug }}">
                            ...
                            <h3><img src="{{ s3_switch($slider->logo ?? 'no_image.png') }}" class="logo img-fluid float-end" width="50" height="50" alt="{{ $slider->title ?: $slider->main_title }}">{{ $slider->title ?: $slider->main_title }}<br>{!!stars($slider->votes, 2)!!}</h3>
            ...
            @if(isset($h1_title))<h1 class="h1-title mb-3">{{$h1_title}}</h1>@endif
            ...
            <div class="shadow-sm p-2 bg-white rounded mb-3 pb-0">
                <div class="m-1">
                    ...
                    <a href="{{ asset($language_prefix.'new-apps') }}" class="more float-start">@lang('general.more') »</a>
                    ...
                    <div class="row app-list">
                        ...
                        <div class="col-4 col-md-4 mb-3">
                            <a href="{{ asset($language_prefix.$settings['app_base']) }}/{{ $app->slug }}">
                                <div class="row">
                                    <div class="col-md-4"><img src="{{ s3_switch($app->image ?? 'no_image.png') }}" class="img-fluid" width="200" height="200" alt="{{ $app->title ?: $app->main_title }}"></div>
                                    <div class="col-md-8 pe-md-0 pt-md-0 pt-2"><span class="title">{{ $app->title ?: $app->main_title }}</span><span class="developer my-1">{{ $app->developer }}</span><span class="date">{{\Carbon\Carbon::parse($app->created_at)->translatedFormat('M d, Y')}}</span></div>
                                </div>
                            </a>
                        </div>
                        @endforeach
            ...
            <div class="shadow-sm p-2 bg-white rounded mb-3">
                <div class="m-1">
                    ...
                    <a href="{{ asset($language_prefix.'featured-apps') }}" class="more float-start">@lang('general.more') »</a>
                    <h2 class="section-title">@lang('general.featured_apps')</h2>

                    <div class="row app-list featured">
                        @foreach ($featured_apps as $app)
                        <div class="col-4 col-md-1-5 @if($loop->last && count($featured_apps) >= 9)d-md-none d-md-block @endif">
                            <a href="{{ asset($language_prefix.$settings['app_base']) }}/{{ $app->slug }}"><img src="{{ s3_switch('pixel.png') }}" data-src="{{ s3_switch($app->image ?? 'no_image.png') }}" class="lazy img-fluid rounded" width="200" height="200" alt="{{ $app->title ?: $app->main_title }}"><span class="title mt-2">{{ $app->title ?: $app->main_title }}</span></a>
                        </div>
            ...
            <div class="shadow-sm p-2 bg-white rounded mb-3 pb-0">
                <div class="m-1">
                    ...
                    <a href="{{ asset($language_prefix.'recently-updated-apps') }}" class="more float-start">@lang('general.more') »</a>
            ...
            <a href="{{ asset($language_prefix.$settings['topic_base']) }}" class="float-start">@lang('general.all_topics') »</a>
            ...
            <div class="shadow-sm p-2 bg-white rounded mb-3 pb-0">
                <div class="m-1">
                    <a href="{{ asset($language_prefix.'must-have-apps') }}" class="more float-start">@lang('general.more') »</a>
                        ...
                        <div class="col-4 col-md-4 mb-3">
                            <a href="{{ asset($language_prefix.$settings['app_base']) }}/{{ $app->slug }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 pe-md-0 pt-md-0 pt-2"><span class="title">{{ $app->title ?: $app->main_title }}</span><span class="developer mt-1">{{ $app->developer }}</span>{!!stars($app->votes, $settings['rating_as_number'])!!}</div>
                                </div>
                            </a>
                        </div>
                        @endforeach
            ...
            <a href="{{ asset($language_prefix.$settings['news_base']) }}" class="float-start">@lang('general.all_news') »</a>
            ...
            <div class="shadow-sm p-2 bg-white rounded mb-3 pb-0">
                <div class="m-1">
                    <a href="{{ asset($language_prefix.'popular-apps-24-hours') }}" class="more float-start">@lang('general.more') »</a>
            ...
            <div class="shadow-sm p-2 bg-white rounded mt-3 pb-0">
                <div class="m-1">
