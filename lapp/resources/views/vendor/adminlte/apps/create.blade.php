    ...
    <div class="m-1">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                {{Form::textarea('description', '', ['class' => 'form-control', 'rows' => '3', 'required' => 'required', 'placeholder' => __('admin.description')])}}
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                {{Form::text('package_name', '', ['class' => 'form-control', 'placeholder' => __('admin.package_name')])}}
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                {!! Form::select('platforms[]', $platforms, old('platforms'), ['class' => 'form-control selectpicker', 'required' => 'required', 'multiple' => 'multiple', 'data-live-search' => 'true', 'id' => 'platforms' ]) !!}
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                {{Form::text('developer', '', ['class' => 'form-control', 'placeholder' => __('admin.developer')])}}
            </div>

            <div class="col-md-4">
                {{Form::label('license', __('admin.license'))}}
                {{Form::text('license', '', ['class' => 'form-control', 'placeholder' => __('admin.license')])}}
            </div>
        ...
        <div class="row mb-2">
            <div class="col-md-12">
                ...
                {{Form::textarea('details', '', ['class' => 'textarea textarea-style', 'id' => 'details', 'placeholder' => __('admin.content')])}}
            </div>
        </div>
