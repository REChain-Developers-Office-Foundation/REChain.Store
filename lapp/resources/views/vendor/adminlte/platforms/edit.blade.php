...
<div class="card p-2">
    <div class="m-1">
        ...
        {!! Form::open(['action' => ['App\Http\Controllers\PlatformController@update', $row->id], 'method' => 'PUT', 'files' => true]) !!}
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-1 mb-md-0 mb-3">
                <div class="position-relative" id="headingTwo" data-delete-prompt-title="@lang('admin.oops')" data-delete-prompt-body="@lang('admin.delete_prompt')" data-yes="@lang('admin.yes')" data-cancel="@lang('admin.cancel')">
                    <img src="{{ s3_switch("$row->image", 5) }}?r={{Str::random(40)}}" class="img-fluid">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <div class="shortcodes mt-1"><b>@lang('admin.supported_shortcodes'):</b> <a href="#">%platform_title%</a><a href="#">%site_title%</a><a href="#">%sep%</a><a href="#">%year%</a><a href="#">%month%</a><a href="#">%day%</a><a href="#">%month_text%</a><a href="#">%day_text%</a></div>
            </div>
        </div>
