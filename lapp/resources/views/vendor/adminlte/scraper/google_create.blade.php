...
<div class="card p-2">
    <div class="m-1">
        ...
        <input type="hidden" name="image" value="{{$app->getIcon()}}" />
        <input type="hidden" name="screenshots" value="{{implode(',', $app->getScreenshots())}}" />
        <input type="hidden" name="app_store" value="1" />

        <div class="row mb-3">
            <div class="col-md-12">
                {{Form::label('title', __('admin.title')." <span class=\"text-danger\">*</span>", [], false)}}
                {{Form::text('title', $app->getName(), ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('admin.title')])}}
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-1 mb-md-0 mb-3">
                <img src="{{$app->getIcon()}}" class="img-fluid">
            </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                {{Form::text('package_name', $app->getId(), ['class' => 'form-control', 'placeholder' => __('admin.package_name')])}}
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                {{Form::text('developer', $app->getDeveloper()->getName(), ['class' => 'form-control', 'placeholder' => __('admin.developer')])}}
            </div>

            <div class="col-md-4">
                {{Form::label('license', __('admin.license'))}}
                {{Form::text('license', $app_price, ['class' => 'form-control', 'placeholder' => __('admin.license')])}}
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                ...
                {{Form::text('version', $app->getAppVersion(), ['class' => 'form-control', 'placeholder' => __('admin.version')])}}
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                {{Form::text('url', $app->getUrl(), ['class' => 'form-control', 'placeholder' => __('admin.download_page_url')])}}
            </div>
